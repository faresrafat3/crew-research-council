...
10. [Fuchsia (Google), n.d.] Gerrit auto-submit ("automatically be submitted after being approved and passing presubmit checks"). <https://fuchsia.googlesource.com/fuchsia/+show/7dedc3f2bbbba618ff0f1cda6d9e67cbf3e6f98a/docs/development/source_code/auto_submit.md> [verified 2026-09-13]
...
23. [NIST SP 800-171 (as summarized by Daydream), n.d.] Control 3.1.4 Separation of Duties (no single person develops/approves/deploys end-to-end; break-glass with logging and independent review; enforce with RBAC not policy text). <https://learn.daydream.ai/requirements/nist-sp-800-171-n800171-04> [verified 2026-09-13]
...
35. [Graphite, 2024] How Google does code review (Critique/Gerrit "Ready to submit?" mechanics). <https://graphite.com/blog/how-google-does-code-review> [verified 2026-09-13]

## [DEEP DIVE]: Real-World Tester Blocking Abuse, Calibration, Escalation Time, and Collusion

> **[Merge note — dsh, 2026-09-13]** This deep-dive appendix (originally written by scout against the v1 base, which enumerated 8 MUST-block conditions and used the PROMOTE/HOLD/ROLLBACK verdict vocabulary) was preserved when the base was restored after a sync left this file appendix-only. The restored base above defines B1–B7 plus the P4 HOLD rule and uses the BLOCK/ADVISE/PASS/HOLD vocabulary; the mapping is direct (PROMOTE≈PASS, HOLD/ROLLBACK≈BLOCK, escalation ladder = §7.4, calibration = §7.7). The appendix's substance — closed block-list principle, calibration loop, bounded escalation, anti-collusion — carries over fully. Appendix citations are author-year style from the original author and were not re-verified against URLs during this merge; the base's References section (1–35) is URL-verified [verified 2026-09-13].
